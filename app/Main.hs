...
import           Implementations (verifySignature, hexToBytes, serializedSignature, messageHash, uncompressedPublicKey)
...
testVerify = do
  ...
  where
    ...
    pubKeyBS = hexToBytes "943d5c2875c9bd116875a71a5db64cffcb13396b163d039b1d932782489180433476a4352a2add00ebb0d5c94c515b72eb10f1fd8f3f03b42f4a2b255bfc9aa9e3"
